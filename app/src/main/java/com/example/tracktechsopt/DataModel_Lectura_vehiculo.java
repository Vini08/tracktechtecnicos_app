...
public class DataModel_Lectura_vehiculo {

    private String id,lecturaH,lecturaV,consumoL,stateL,fechaL,fechaH, nombr, hora_a, hora_fin;
Bitmap img;
    public DataModel_Lectura_vehiculo(String ids, String idin, String iduserr, String eje, String cli, String mod, Bitmap im, String imeis, String nam, String ha, String hx) {
        this.id=ids;
        this.lecturaH=idin;
